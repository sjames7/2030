******************************************************
* WIRE681.x68   sHIJU JAMES - Nov 23                                     *
*                                                    *
...
*        USES:    no subroutines                     *
******************************************************
OUT681   MOVE.B   D0,OPR_SET(A0) ;clr. bits, set pins
         NOT.B    D0             ;opposite input to clr 
         MOVE.B   D0,OPR_CLR(A0) ;set bits, clr. pins
         NOT.B    D0             ;restore D0
         RTS
EXIT     
         TRAP   #14
         MOVE.L   #$00,OPR_SET(A0)
         RTS
         END      WIRE681
